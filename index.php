...
<head>
    ...
    <script>
        ...
        function loadChartData() {
            ...
            fetch(`getChartsData.php?type=${chartType}`)
                ...
                .then(dataPoints => {
                    if (!chart) {
                        chart = new CanvasJS.Chart("chartContainer", {
                            ...
                            title: {
                                text: "Kategori Barbershop dan Salon"
                            },
                            subtitles: [{
                                text: "Desember 2024"
                            }],
                    ...
                    chart.options.data[0].dataPoints.forEach(point => {
                        if (chartType === "harga") {
                            if (point.label === "Terjangkau") point.color = "#5CB338";
                            if (point.label === "Sedang") point.color = "#ECE852";
                            if (point.label === "Mahal") point.color = "#FB4141";
                        } else if (chartType === "gender") {
                            if (point.label === "Pria") point.color = "#4B77BE";
                            if (point.label === "Wanita") point.color = "#F39C12";
                        }
                    });
        ...
        // Muat chart default saat halaman dimuat
...
<body>
    ...
    <div class="filter-container">
        ...
        <select id="chartType" onchange="loadChartData()">
